...
export const RELEASES = [
  {
    ...
    date: "2026-09-21",
    items: [
      "Fill-in-the-blank cards now ask for the word you actually hid. A card with several blanks no longer repeats the first answer, and selecting text across two lines works too.",
    ],
  },
  {
    version: "1.4.0",
  ...
  },
  {
    ...
    date: "2026-09-15",
    items: [
      "The app now tells you when there's a newer version, with a button to get it. The Android app doesn't update itself \u2014 it never has \u2014 so until now the only way to find out a fix had shipped was to go looking for one. Turn a version down and it won't ask again about that one; the next release will still say hello.",
    ],
  },
  {
    version: "1.2.9",
  ...
  },
  {
    ...
    date: "2026-09-15",
    items: [
      "Card pictures have moved into proper device storage, which is the real fix for last release's missing cards. They used to sit in the same small space as your whole catalog \u2014 about thirty photographed cards was enough to leave no room for it \u2014 and they now have a space of their own, hundreds of times larger. Your existing pictures are moved across the first time you open the app; nothing to do.",
    ],
  },
  {
    version: "1.2.7",
  ...
  },
  {
    ...
    date: "2026-09-01",
    items: [
      "The web version can hand you the Android app: Settings \u2192 Android app downloads the newest build directly, instead of sending you off to find it. A sideloaded app doesn't update itself, so that button is where the next version comes from too.",
    ],
  },
  {
    version: "1.2.4",
